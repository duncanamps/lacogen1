...
uses
  Classes, SysUtils;
type
  TProgOptions = (poCompile,poDump,poHelp,poInfo,poRedistribution,poVerbose,poWarAndPeace,poXML);
  ...
  CMD_OPTIONS: array[TProgOptions] of TOptions =
    ((ShortOption: 'c';
     ...
     (ShortOption: 'i';
      ...
      ParamReqd:   opNone;
      Parameter:   '';
      Description: 'Display info about the licence and warranty'),

     (ShortOption: 'r';
      LongOption:  'redistribution';
      ParamReqd:   opNone;
      Parameter:   '';
      Description: 'Display info about redistributing the software'),
